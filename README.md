...
E.g. if your data for ModelNet-C is in `./data/tta_datasets/modelnet-c`, set the variable to `./data/tta_datasets`. Please set the method on "Tent_WA_FPS" (our method) or "Tent_Modified" (original tent).
