...
from tools.tta import tta, tta_tent, tta_shot, tta_dua, tta_t3a, tta_rotnet, loss_visualization_infer
import time
import os
import torch
...
def main(args):
    ...
    if args.dataset_name not in ['modelnet', 'scanobject', 'partnet', 'shapenetcore', 'shapenet', 'scanobject_cvpr']:
    ...
    args.batch_size = 10       
    args.batch_size = config.model.transformer_config.batch_size         
    ...
    #loss_visualization_infer(args, config)  
